...
2. Select `Games` > `Add a Non-Steam Game to My Library` <figure><img src="../../.gitbook/assets/installNonSteamGame.png" alt=""><figcaption><p>Add a Non-Steam Game to My Library Menu Option</p></figcaption></figure>
...
##### Option 2: Enable Steam Input Manually
